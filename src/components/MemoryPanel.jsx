    ...
    <div className="flex flex-col h-full">
      <div className="flex items-center justify-between px-4 py-3 flex-shrink-0"
        ...
        <div className="flex gap-2">
          <button onClick={() => setShowAdd(true)} className="flex items-center gap-1 px-3 py-1.5 rounded text-xs font-mono text-blue-400 border border-blue-900 hover:border-blue-600 transition-all">
            <Plus size={11} /> ADD
          </button>
          <button onClick={clearAll} className="flex items-center gap-1 px-3 py-1.5 rounded text-xs font-mono text-red-700 border border-red-900 hover:border-red-700 transition-all">
