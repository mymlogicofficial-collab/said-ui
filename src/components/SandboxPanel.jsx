  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex items-center gap-2 px-3 py-2 flex-shrink-0"
        ...
        <button onClick={runCode} className="flex items-center gap-1.5 px-3 py-1.5 rounded text-xs font-mono text-white"
      ...
      <div className="flex-1 overflow-hidden flex">
        {(view === "split" || view === "code") && (
          <div className={`flex flex-col ${view === "split" ? "w-1/2 border-r border-gray-900" : "w-full"}`}>
            <div className="px-3 py-1.5 flex-shrink-0" style={{ background: "#080812", borderBottom: "1px solid #1a1a2e" }}>
